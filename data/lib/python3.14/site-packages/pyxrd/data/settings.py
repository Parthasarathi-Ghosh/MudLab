...
LOG_FILENAME = os.path.join(user_log_dir('PyXRD.clays'), 'errors.log')

### The URL where PyXRD.clays looks for updates & the online manual ###
UPDATE_URL = 'https://github.com/KazukiNoSuzaku/PyXRD.clays'
...
DATA_DIRS = [
    ("DEFAULT_DATA", "./", None),
    ("USER_DATA", user_data_dir('PyXRD.clays'), None),
    ("LOG_DIR", user_log_dir('PyXRD.clays'), None),
...
def _parse_args():
    ...
    parser.add_argument(
        ...
        help="A PyXRD.clays project filename"
    )
    parser.add_argument(
        "-s", "--script", default="",
