...
def optimize_mixture(mixture, force=False):
    ...
    if not mixture.optimized or force:
        ...
        # 1. setup start point:
        # Warm-start from previous solution if available; fall back to zero solution on first call
        x0 = get_solution(mixture) if mixture.optimized else get_zero_solution(mixture)
