...
if sys.platform == "win32":
    ...
    # core.py lives in <root>/lib/python3.14/site-packages/pyxrd/
...
def _run_gui(project=None):
    ...
    filename = str(importlib.resources.files(__name__).joinpath("application/icons/pyxrd.png"))
...
def run_main():
    """
        Parsers command line arguments and launches PyXRD.clays accordingly.
    """
