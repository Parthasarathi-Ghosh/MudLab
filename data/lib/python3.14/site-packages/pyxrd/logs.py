...
def setup_logging(basic=False, prefix=None):
    ...
    if not basic:
        ...
        # Setup console log (utf-8 to handle unicode characters like σ on Windows):
        log_handler = logging.StreamHandler()
        log_handler.stream = open(log_handler.stream.fileno(), mode='w', encoding='utf-8', errors='replace', closefd=False)
