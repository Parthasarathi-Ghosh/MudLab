...
class EditInSituMixtureView(BaseView):
    ...
    def add_phase_slot(self, 
        ...
        self.behav_combos.resize((c - self.base_width, r + 1 - self.base_height), refcheck=False)
    ...
    def add_specimen_slot(self,
        ...
        self.behav_combos.resize((c + 1 - self.base_width, r - self.base_height), refcheck=False)
