...
from mudlab.mixture.models import InSituBehaviour, insitu_behaviours
from mudlab.mixture.views import EditInSituBehaviourView


from mudlab.mixture.views.add_insitu_behaviour_view import AddInSituBehaviourView
