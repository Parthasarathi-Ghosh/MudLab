...
def user_data_dir(appname=None, appauthor=None, version=None, roaming=False):
    ...
    Typical user data directories are:
        ...
        (When appauthor is provided: ...\<AppAuthor>\<AppName>)

    For Unix, we follow the XDG spec and support $XDG_DATA_HOME.
    That means, by deafult "~/.local/share/<AppName>".
    
    On all platforms we support overriding all of this by setting the
    $MUDLAB_USER_DATA_DIR environment variable to the value of choice.
    """
    path = os.getenv("MUDLAB_USER_DATA_DIR", None)
    if path is None:
...
def site_data_dir(appname=None, appauthor=None, version=None, multipath=False):
    ...
    Typical user data directories are:
        ...
        Win 10+:    C:\\ProgramData\\<AppAuthor>\\<AppName>
...
def user_cache_dir(appname=None, appauthor=None, version=None, opinion=True):
    ...
    On all platforms we support overriding all of this by setting the
    $MUDLAB_USER_CACHE_DIR environment variable to the value of choice.
    """
    path = os.getenv("MUDLAB_USER_CACHE_DIR", None)
    if path is None:
