...
LOG_FILENAME = os.path.join(user_log_dir('MudLab'), 'errors.log')

### The URL where MudLab looks for updates & the online manual ###
UPDATE_URL = 'https://github.com/Parthasarathi-Ghosh/MudLab'
MANUAL_URL = 'https://github.com/Parthasarathi-Ghosh/MudLab/blob/main/docs/index.md'
...
DEFAULT_LAYOUT = "FULL" # one of the keys in DEFAULT_LAYOUTS!
DEFAULT_LAYOUTS = {
    "FULL": "Full",
    "VIEWER": "View-mode"
}
...
PATTERN_SMOOTH_TYPES = {
    0: "Moving Triangle",
    1: "Savitzky-Golay",
    2: "Gaussian",
    3: "Moving Average",
    4: "Smoothing Spline",
    5: "Butterworth (filtfilt)",
}
...
DATA_DIRS = [
    ("DEFAULT_DATA", "./", None),
    ("USER_DATA", user_data_dir('MudLab'), None),
    ("LOG_DIR", user_log_dir('MudLab'), None),
...
ASYNC_SERER_PROVIDERS = [
   "mudlab.generic.asynchronous.dummy_async_provider.DummyAsyncServerProvider",
]
...
def _parse_args():
    ...
    parser.add_argument(
        ...
        help="A MudLab project filename"
    )
    parser.add_argument(
        "-s", "--script", default="",
...
def initialize(override_debug=DEBUG, splash=None):
    """Apply runtime settings, can and needs to be called only once.
    If splash is given, it is used to show progress messages during init."""
    ...
    if not __apply_lock__ and not SETTINGS_APPLIED:
		...
		'sans-serif' : 'Helvetica, Arial, sans-serif',
            ...
            if splash:
                splash.set_message("Loading icons ...")
