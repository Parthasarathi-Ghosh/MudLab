    ...
    def load_project(self):
        ...
        def on_accept(dialog):
            ...
            with DialogFactory.error_dialog_handler(
                ...
                # The object pool is cleared inside JSONProjectParser._parse_data
                # (the load boundary shared by the GUI and headless callers), so
                # a previous project cannot collide with this one - see the note
                # there. new_project clears it separately, as it builds an empty
                # Project without going through a parser.
