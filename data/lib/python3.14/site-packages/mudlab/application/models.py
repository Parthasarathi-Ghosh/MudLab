...
from mudlab.generic.models import MudLabModel
from mudlab.generic.io.json_codec import MudLabEncoder
...
class AppModel(MudLabModel):
    ...
    # ------------------------------------------------------------
    @MudLabModel.observe("data_changed", signal=True)
    @MudLabModel.observe("visuals_changed", signal=True)
    ...
    def update_project_last_save_hash(self):
        if self.current_project is not None:
            dump = MudLabEncoder.dump_object(self.current_project).encode(errors='ignore')
