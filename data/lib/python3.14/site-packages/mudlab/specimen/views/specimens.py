...
from mudlab.generic.views import DialogView, BaseView, HasChildView

from mudlab.goniometer.views import InlineGoniometerView
from mudlab.generic.views.line_views import CalculatedLinePropertiesView, ExperimentalLinePropertiesView
