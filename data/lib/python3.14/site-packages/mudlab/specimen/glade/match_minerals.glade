...
<interface>
  ...
  <object class="GtkTable" id="tbl_match_minerals">
    ...
    <child>
      <!-- Target indicator — set by MatchMineralController to the selected marker's label -->
      <object class="GtkLabel" id="lbl_target">
        <property name="visible">True</property>
        <property name="can_focus">False</property>
        <property name="label" translatable="yes">Target marker:</property>
    ...
    <child>
      <object class="GtkCheckButton" id="chk_use_specimen_range">
        <property name="label" translatable="yes">Specimen range</property>
        <property name="visible">True</property>
        <property name="can_focus">True</property>
