...
from mudlab.file_parsers.csv_base_parser import CSVBaseParser
...
class ATLAtomTypeParser(CSVBaseParser):
    ...
    def write(cls, filename, items, props):
        ...
        with open(filename, 'w', newline='', encoding='utf-8') as f:
            ...
            for item in items:
                prop_row = [getattr(item, prop) for prop, name in props]
