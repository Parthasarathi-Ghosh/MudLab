...
from mudlab.generic.asynchronous.cancellable import Cancellable
...
from .deap_utils import mudlab_array, FitnessMin, result_func
...
class RefinePSOCMAESRun(RefineMethod):
    ...
    def _setup(self, refiner, ngen=NGEN, ngen_comm=NGEN_COMM, nswarms=NSWARMS, **kwargs):
        if not self._has_been_setup:
            ...
            halloffame = HallOfFame(1, similar=lambda a1, a2: np.all(a1 == a2)) #MudLabParetoFront(similar=lambda a1, a2: np.all(a1 == a2))
