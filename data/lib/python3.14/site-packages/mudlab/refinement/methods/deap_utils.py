...
class mudlab_array(creator._numpy_array):
    """
        ...
        fitnesses for MudLab parameter solutions.
    """
    min_bounds = None
    max_bounds = None
    ...
    def __setitem__(self, i, y):
        if isinstance(i, slice):
            y = np.array(y)
            np.clip(y, self.min_bounds[i], self.max_bounds[i], y)
        else:
...
class MudLabParetoFront(ParetoFront):
