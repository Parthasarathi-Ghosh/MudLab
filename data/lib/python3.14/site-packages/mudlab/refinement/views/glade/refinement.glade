  ...
  <object class="GtkTable" id="refine_params">
    ...
    <child>
      <object class="GtkHBox" id="hbox_actions">
        ...
        <child>
          <object class="GtkCheckButton" id="use_intensity_cache">
            <property name="label" translatable="yes">Use intensity cache</property>
            <property name="visible">True</property>
            <property name="can_focus">True</property>
            <property name="receives_default">False</property>
            <property name="active">True</property>
            <property name="tooltip_text" translatable="yes">Cache phase intensities for unchanged phases to speed up refinement. Disable to verify results.</property>
            <property name="xalign">0.5</property>
            <property name="draw_indicator">True</property>
          </object>
          <packing>
