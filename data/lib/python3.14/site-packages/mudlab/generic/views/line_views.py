...
class SmoothDataView(DialogView):
    ...
    def __init__(self, *args, **kwargs):
        ...
        # Replace the single OK button with Apply + Cancel button box
        btn_ok = self["btn_ok"]
        algn = self["algn_btn_ok"]

        self.btn_cancel = Gtk.Button(label="Cancel")
        self.btn_cancel.set_size_request(75, -1)

        hbox = Gtk.HBox(spacing=6)
        # Re-parent OK button into the hbox
        btn_ok.get_parent().remove(btn_ok)
        btn_ok.set_label("Apply")
        hbox.pack_end(btn_ok, False, False, 0)
        hbox.pack_end(self.btn_cancel, False, False, 0)
