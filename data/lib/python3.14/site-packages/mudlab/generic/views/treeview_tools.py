...
class MudLabTreeViewColumn(Gtk.TreeViewColumn):
    """
...
def _get_default_column(title, rend,
        ...
        col_attrs={}):
    """
        Creates a MudLabTreeViewColumn using the arguments passed. Column 
    ...
    col = MudLabTreeViewColumn(title, rend, **col_attrs)
