...
class MudLabModel(Model):
    """
        A UUIDModel with some common MudLab functionality
    """
...
class ChildModel(MudLabModel):
    """
        A MudLabModel with child-parent relation support.
    """

    # MODEL INTEL:
    class Meta(MudLabModel.Meta):
