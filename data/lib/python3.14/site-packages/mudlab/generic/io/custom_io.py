...
from .json_codec import MudLabDecoder, MudLabEncoder
...
class StorableRegistry(dict):
    ...
    aliases = {
        ...
        'generic.models/MudLabLine': 'MudLabLine',
...
class Storable(object):
    ...
    def dump_object(self, zipped=False):
        ...
        """
        content = MudLabEncoder.dump_object(self)
        if zipped:
            f = StringIO()
    ...
    def parse_init_arg(self, arg, default, child=False, default_is_class=False, **kwargs):
        ...
        **kwargs* any other kwargs are passed to the JSON decoder if the passed
        ...
        if arg == None:
            ...
            arg = MudLabDecoder(mapper=storables, parent=self if child else None).__mudlab_decode__(arg, **kwargs)
            return arg
        else:
            return arg
