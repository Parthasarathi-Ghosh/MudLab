...
def get_factors(range_stl, component):
    ...
    Returns a tuple containing the structure factor and phase difference for
        ...
        - component: a :class:`~mudlab.calculations.data_objects.ComponentData`
          instance containing two lists of layer and interlayer
          :class:`~mudlab.calculations.data_objects.Atom`'s.
          
    This function calls 
    :meth:`~mudlab.calculations.atoms.get_structure_factor` for each
