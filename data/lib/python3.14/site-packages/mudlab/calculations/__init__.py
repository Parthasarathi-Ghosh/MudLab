...
:class:`~mudlab.calculations.DataObject` sub-class, which wraps all the data in a single object. 
These :class:`~mudlab.calculations.DataObject` s map onto the different models used. As such this 
