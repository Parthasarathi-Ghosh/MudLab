...
class MixtureData(DataObject):
    ...
    #: Average residual across specimens (set by optimize_mixture / read by
    #: get_optimized_residual). Defaulted so readers never hit AttributeError
    #: when the optimize/calculate path short-circuits on an AssertionError.
    residual = None

    #: [average, specimen_1, specimen_2, ...] residuals produced by
    #: calculate_mixture. Same default-safety rationale as `residual`.
    residuals = None
