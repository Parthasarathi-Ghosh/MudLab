...
def get_atomic_scattering_factor(angstrom_range, atom_type):
    ...
    Calculates the atomic scatter factor for 
        ...
        - atom_type: an :class:`~mudlab.calculations.data_objects.AtomTypeData`
          instance
    ...
    if atom_type is not None:
        ...
        logger.debug("get_atomic_scattering_factor reports: 'None found!'")
...
def get_structure_factor(range_stl, atom):
    ...
    Calculates the atom's structure factor for
        ...
        - atom_type: an :class:`~mudlab.calculations.data_objects.AtomData`
          instance 
          
    The structure factor is calculated using the atomic scattering factor ASF
    (calculated by :meth:`~mudlab.calculations.atoms.get_atomic_scattering_factor`)
    as follows:
    ...
    if atom is not None and atom.atom_type is not None:
        ...
        logger.debug("get_structure_factor reports: 'None found!'")
