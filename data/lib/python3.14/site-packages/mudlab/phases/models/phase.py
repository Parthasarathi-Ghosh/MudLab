...
from mudlab.generic.io import storables, get_case_insensitive_glob

from mudlab.generic.models.properties import InheritableMixin, ObserveChildMixin
...
from mudlab.probabilities.models import get_correct_probability_model
...
@storables.register()
class Phase(RefinementGroup, AbstractPhase, metaclass=MudLabRefinableMeta):
    ...
    # A :class:`~mudlab.phases.models.CSDS` instance
    ...
    # A :class:`~mudlab._probabilities.models._AbstractProbability` subclass instance
    ...
    def __init__(self, *args, **kwargs):
        ...
        with self.data_changed.hold():
            ...
            if isinstance(CSDS_distribution, dict):
                _pool_uuid = CSDS_distribution.get("properties", {}).get("uuid")
                if _pool_uuid:
                    _existing = type(type(self)).object_pool.get_object(_pool_uuid)
                    if _existing is not None:
                        CSDS_distribution = _existing
