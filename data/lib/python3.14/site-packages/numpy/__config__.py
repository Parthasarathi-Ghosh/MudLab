...
CONFIG = _cleanup(
    {
        ...
        "Build Dependencies": {
            "blas": {
                ...
                "include directory": r"D:/M/msys64/mingw64/include/openblas",
                "lib directory": r"D:/M/msys64/mingw64/lib",
                ...
                "pc file directory": r"D:/M/msys64/mingw64/lib/pkgconfig",
            },
            "lapack": {
                "name": "openblas",
                "found": bool("True".lower().replace("false", "")),
        ...
        "Python Information": {
            "path": r"D:/M/msys64/mingw64/bin/python.exe",
            "version": "3.14",
        },
        "SIMD Extensions": {
